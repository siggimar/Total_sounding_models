...
def data_to_kde( x, y, logx=True, logy=True, N=100, xlims=None, ylims=None ):
    ...
    if not xlims: xlims = (np.log10(1e-1),np.log10(1e4 ))
    if not ylims: ylims = (np.log10(1e-3),np.log10(1e2 ))
...
if __name__=='__main__':
    ...
    for i in range(1,2):
        summary(n=i, f_name='fig_8_simplified_03_SBT_chart.png', detailed=True, N=200) # 'all_classes_' + str(i) + '.png', all_classes_' + str(i) + '.png # N > 300 useable - 500 used in paper.