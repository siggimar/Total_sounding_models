...
# 6:Hammering (1/0)
        ...
        self.multicolor_label( ax5,('Penetration force (kN)',' '),(self.colors['f_dt'],self.colors['f_dt']),\
                              axis='x',size=10,weight='normal',rotation=0, bbox_to_anchor=(.2, -0.08) )
        self.multicolor_label( ax1,('      Penetration time (s/m)',' '), (self.colors['rate'],\
                        self.colors['rate']),axis='x',size=10,weight='normal',rotation=0, bbox_to_anchor=(0, -0.08) )
        self.multicolor_label( ax1,('     Flushing pressure (MPa)',' '), (self.colors['flush_pressure'],\
                              self.colors['flush_pressure']),axis='x',size=10,weight='normal',rotation=0, bbox_to_anchor=(0, -0.1) )
