...
'''
Module to showcase smoothing LOWESS, moving average and std(F_DT) for total soundings.

1 curve from training set   
...
def plot_smoothing_data( datasets ):
    location_f_size = 18
    title_f_size = 14
    tick_f_size = 12
