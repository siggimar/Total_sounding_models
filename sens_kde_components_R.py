...
# y var here:  f_dt_res which is F_dt- with lowess estimate of F_dt subtracted.
# hence, rooting it's square divided by n, returns R.
# placed in separate file as get_data is significantly modified.
...
if __name__=='__main__':
    ...
    for model_id in [ 0 ]:#, 1, 2 ]:
        for d_set in range(0,10):
            ...
            #plt.savefig(model_info[model_id]['base_name'] + str(d_set) +  '.png', dpi=150)            
            plt.show()
