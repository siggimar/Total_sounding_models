...
class unit_model():
    ...
    class unit():
        ...
        def draw( self, ax, fontsize, label=None ):
            ...
            ax.plot( x, y_top, ls='--', c=(0,0,0), lw=0.5, zorder=-1 )
            ax.plot( x, y_bottom, ls='--', c=(0,0,0), lw=0.5, zorder=-1 )

            ax.fill_between( x, y_bottom, y_top, color=unit_color, zorder=-2 ) # alpha=0.2
