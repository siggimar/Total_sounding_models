import os
import numpy as np
from curve_correlation.smoothers import lowess
from curve_correlation.alfa_beta import calibration_data
from curve_correlation.cpt_log import log_file
            ...
            if '=' in line:
                ...
                for key in self.data:
                    if key not in used_keys: # only first registration
                        ...
                        val = np.float(val) if val else np.nan                        
