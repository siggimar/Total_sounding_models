...
from curve_correlation.soil_stresses import soil_stress_model
from curve_correlation.cpt import cpt
...
class dataset():
    ...
    def __init__( self ):
        self.saves_folder = 'curve_correlation/saves'
    ...
    def load_dataset( self, location=0, borehole=-1, read_logfiles=False, from_file='', txt_overview=False ):
        ...
        base_dir = 'curve_correlation/data'
